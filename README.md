...
[ x]1. Create the cart method in `ApplicationController#cart`, this method should return an array of the items stored in the cart (utilizing the Rails `session` method).

[ x]2. Create a Products controller with two actions, index and add.
